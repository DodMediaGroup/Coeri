...
class Controller extends CController
{
	...
	public $pageTitle = 'Coeri, Inmobiliaria';
	public $pageDescription = 'Somos una empresa boyacense encargada de gestionar proyectos inmobiliarios con calidad y éxito';
